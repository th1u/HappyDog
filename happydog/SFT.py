...
def init_model(lm_config):
    ...
    ckp = f'./checkpoints/pretrain.pth'
...
if __name__ == "__main__":
     ...
     parser.add_argument("--wandb_project", type=str, default="HappyDog-SFT")
     ...
     parser.add_argument("--data_path", type=str, default="/root/fs/sft_512.jsonl")
     ...
     args.wandb_run_name = f"SpongeBob-SFT-Epoch-{args.epochs}"
