...
def init_model(lm_config):
    ...
    ckp = f'./checkpoints/SFT_1024.pth'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="HappyDog-Distill")
    ...
    args.wandb_run_name = f"HappyDog-Distill-Epoch-{args.epochs}"
